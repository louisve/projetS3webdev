...
app.get('/liste', checkSignIn, listeGet);
app.post('/liste', checkSignIn, listePost);
app.delete('/liste/:id', checkSignIn, listeDelete);
app.put('/liste/:id', checkSignIn, listePut);
